...
namespace ConferenceManagementSystem.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Username,Password,ConfirmedPassword,Name,Email,PhoneNumber,Address")] Admin admin)
        {
            if (ModelState.IsValid)
            {
                admin.encryptedPassword = Function.Encrypt(admin.Password);
                db.Admins.Add(admin);
                db.SaveChanges();
