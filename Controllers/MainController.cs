...
namespace ConferenceManagementSystem.Controllers
{
    ...
    public class MainController : Controller
    {
        ...
        public ActionResult Home(int? id)
        {
            ...
            if(content!=null && content.WelcomeText != null)
            {
            ...
            Conference conference = db.Conferences.FirstOrDefault(u => u.ConferenceId == conferenceId);
            Session["ConferenceId"] = conference.ConferenceId;
            Session["ConferenceName"] = conference.ConferenceName;
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ConferenceId,Username,encryptedPassword,ConferenceName,Website,Date,ContactName,Contact,PaperPrefix,LinkDirectory,LoggedIn,Logo,Short_Name,ChairmanName,ChairmanEmail,ConferencePhone,SystemEmail,SecretariatAddress,ConferenceTime,ConferenceVenue")] Conference conference)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ConferenceId,Username,encryptedPassword,ConferenceName,Website,Date,ContactName,Contact,PaperPrefix,LinkDirectory,LoggedIn,Logo,Short_Name,ChairmanName,ChairmanEmail,ConferencePhone,SystemEmail,SecretariatAddress,ConferenceTime,ConferenceVenue")] Conference conference)
        {
            if (ModelState.IsValid)
            {
