        ...
        public ActionResult Login(Admin model)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (admin != null && Utilities.Function.LoginAsAdmin(model.Username, model.Password) == true)
                    {
                    ...
                    else if (conference != null && Utilities.Function.LoginAsOrganizer(model.Username, model.Password) == true)
                    {
                        Session["sessionLoggedInUserName"] = model.Username;
                        Session["sessionLoggedInUserId"] = conference.ConferenceId;
                        Session["name"] = "conference";
                    ...
                    else if (User != null && Utilities.Function.LoginAsUser(model.Username, model.Password) == true)
                    {
                        Session["sessionLoggedInUserName"] = model.Username;
